...
def buildTFNeuralNet(x, y, eps = 6):
    model = Sequential()
    model.add(Dense(50, kernel_initializer='random_normal', input_dim=(IS), activation='sigmoid'))
    model.add(Dropout(0.1))
    model.add(Dense(65, kernel_initializer='random_normal', activation='sigmoid'))
    model.add(Dropout(0.1))
...
def buildTFConvNet(x, y, eps = 10, dropout = True, dropRate = 0.2):
    ...
    if DATASET == "cifar_10" or DATASET == "cifar_100_f" or DATASET == "cifar_100_c":
      model.add(Conv2D(32, kernel_size=(3,3), input_shape=(IH, IW, 3), activation='sigmoid'))
    else:
      model.add(Conv2D(32, kernel_size=(3,3), input_shape=(IH, IW, 1), activation='sigmoid'))
